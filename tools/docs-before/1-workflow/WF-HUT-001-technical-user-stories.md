# 🎯 Workflow: Technical User Stories (HUTs) Creation & Refinement

---

**metodo**: ZNS v2.2  
**workflow_id**: WF-HUT-001  
**version**: 2.0.0  
...
**changelog**:
- v2.0.0: Menú de orquestación con opciones Documentar/Afinar + Integración agentes técnicos (2026-02-07)
- v1.1.0: Terminal Interactiva integrada (2026-02-07)
- v1.0.0: Versión inicial del workflow

---

## 🖥️ WF-HUT-001 | ORQUESTADOR HUTs | `/workflow:hut`
...
| `3` | `/hut:backend` | **☕ HUTs Backend** | Generar HUTs específicas de Spring Boot | ☕ Backend Senior |
...
|--------|--------|--------------|
| ☕ **Backend Senior** | `2-agents/zns-tecnical-team/5.zns-develop/1.backend_senior/prompt-dev-springboot-senior.md` | Spring Boot, Java 21, APIs REST |
...
| Backend Spring Boot | `/hut:backend` → `prompt-dev-springboot-senior.md` |
...
## ☕ OPCIÓN 3: HUTs Backend (`/hut:backend`)
...
## OUTPUT
HUTs en: `0-docs/3-technical-stories/2-api/HUT-API-XXX-*.md`
```
...
| **AGT-BACKEND** | Senior Spring Boot Developer | HUT-DOM, HUT-UC, HUT-API, HUT-SEC, HUT-PERF |
...
**Prompt:** `1-agents/zns-product-owner/8.technical-user-stories/prompt-technical-user-stories.md`  
**Duration:** 15-20 min  
...
**Prompt:** `1-agents/zns-develop-agent/1.backend_senior/prompt-dev-springboot-senior.md`  
**Duration:** 30-45 min  
...
**Agent:** AGT-FRONTEND  
**Prompt:** `1-agents/zns-develop-agent/2.frontend_senior/prompt-dev-frontend-angular-senior.md`  
**Duration:** 30-45 min  
...
**Prompts:** 
- `1-agents/zns-develop-agent/4.database_senior/prompt_dev_database_senior.md`
- `1-agents/zns-develop-agent/1.backend_senior/prompt_dev_senior_flyway.md`  
**Duration:** 30-45 min  
...
**Agent:** AGT-TECH-ARCHITECT  
**Prompt:** `1-agents/zns-product-owner/8.technical-user-stories/checklist-huts-validation.md`  
**Duration:** 15-20 min  
...
1-agents/zns-product-owner/8.technical-user-stories/prompt-technical-user-stories.md
...
@agent: Assume the role defined in:
1-agents/zns-develop-agent/1.backend_senior/prompt-dev-springboot-senior.md

Create HUTs for Domain, Use Cases, and API layers following:
- Hexagonal Architecture
- DDD Tactical Patterns
- Spring Boot 3.4.x standards

Aggregates: [from STEP-002]

# STEP-004: Frontend HUTs
@agent: Assume the role defined in:
1-agents/zns-develop-agent/2.frontend_senior/prompt-dev-frontend-angular-senior.md
...
1-agents/zns-product-owner/8.technical-user-stories/checklist-huts-validation.md
